...
import { EventsDestroyParams, EventsShowParams, EventsNewParams } from '../interfaces/params/SendingAndReceivingEventsParams';
import { IndicateTypingParams } from '../interfaces/params/TypingIndicatorAndReadReceiptsParams';
import { WelcomeMessagesRulesShowParams, WelcomeMessagesShowParams, WelcomeMessagesNewParams, WelcomeMessagesRulesNewParams, WelcomeMessagesListParams, WelcomeMessagesDestroyParams, WelcomeMessagesRulesDestroyParams } from '../interfaces/params/WelcomeMessagesParams';
...
declare class DirectMessagesClient {
     ...
     * @param parameters
     */
    eventsDestroy(parameters: EventsDestroyParams): Promise<unknown>;
    /**
     ...
     * @param parameters
     */
    eventsShow(parameters: EventsShowParams): Promise<EventsShow>;
    /**
     ...
     * @param parameters
     */
    eventsNew(parameters: EventsNewParams): Promise<EventsNew>;
    /**
     ...
     * @param parameters
     */
    indicateTyping(parameters: IndicateTypingParams): Promise<unknown>;
    /**
     ...
     * @param parameters
     */
    welcomeMessagesRulesShow(parameters: WelcomeMessagesRulesShowParams): Promise<WelcomeMessagesRulesShow>;
    /**
     ...
     * @param parameters
     */
    welcomeMessagesShow(parameters: WelcomeMessagesShowParams): Promise<WelcomeMessagesShow>;
    /**
     ...
     * @param parameters
     */
    welcomeMessagesNew(parameters: WelcomeMessagesNewParams): Promise<WelcomeMessagesNew>;
    /**
     ...
     * @param parameters
     */
    welcomeMessagesRulesNew(parameters: WelcomeMessagesRulesNewParams): Promise<WelcomeMessagesRulesNew>;
    /**
     ...
     * @param parameters
     */
    welcomeMessagesList(parameters?: WelcomeMessagesListParams): Promise<WelcomeMessagesList>;
    /**
     * Returns a list of Welcome Messages.
     *
     ...
     * @param parameters
     */
    welcomeMessagesDestroy(parameters: WelcomeMessagesDestroyParams): Promise<unknown>;
    /**
     * Returns a list of Welcome Messages.
     *
     ...
     * @param parameters
     */
    welcomeMessagesRulesDestroy(parameters: WelcomeMessagesRulesDestroyParams): Promise<unknown>;
}
